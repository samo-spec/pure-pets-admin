...
private struct AdminStaffPermissionsInspectorSheet: View {
    ...
    private var allPermissions: [PermissionItem] {
        ...
        return [
            ...
            PermissionItem(id: "pos.sell.wholesale", title: Language.get("StaffPermTitle_pos_sell_wholesale", alter: "البيع بسعر الجملة عبر نقطة البيع"), domain: payDomain, domainIcon: "tag.fill", isGranted: role == .owner || role == .superAdmin || role == .operationsManager),
