...
struct AdminAccountView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                AdminLegacyViewControllerWrapper {
                    ...
                    let profileVC = PPAdminProfileViewController(user: user)
                    return profileVC
                }
            }
        }
    ...
    private var dossierHeaderView: some View {
        VStack(alignment: .leading, spacing: AdminSpacing.xs) {
            ...
            Text(Language.get("CommandCenter_Tab_More", alter: "المزيد") + " / " + Language.get("EditMyAccount_Title", alter: "الحساب"))
                .font(AdminType.caption1)
                .foregroundColor(AdminSurface.secondaryText)
                .padding(.top, 2)

            Text(Language.get("EditMyAccount_Title", alter: "الملف الشخصي والحساب"))
