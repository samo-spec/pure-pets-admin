...
struct AdminCategoriesView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                AdminLegacyViewControllerWrapper { PPCategoriesViewController() }
            }
        }
    ...
    private var dossierHeaderView: some View {
        VStack(alignment: .leading, spacing: AdminSpacing.xs) {
            ...
            Text(Language.get("CommandCenter_Tab_More", alter: "المزيد") + " / " + Language.get("Categories_Title", alter: "الفئات"))
                .font(AdminType.caption1)
                .foregroundColor(AdminSurface.secondaryText)
                .padding(.top, 2)

            Text(Language.get("Categories_Title", alter: "إدارة الفئات والأقسام"))
