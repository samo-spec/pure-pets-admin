...
struct AdminAccountingView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                AdminLegacyViewControllerWrapper { PPAccountingViewController() }
            }
        }
    ...
    private var dossierHeaderView: some View {
        VStack(alignment: .leading, spacing: AdminSpacing.xs) {
            ...
            Text(Language.get("CommandCenter_Tab_More", alter: "المزيد") + " / " + Language.get("Accounting_Title", alter: "المحاسبة"))
                .font(AdminType.caption1)
                .foregroundColor(AdminSurface.secondaryText)
                .padding(.top, 2)

            Text(Language.get("Accounting_Title", alter: "المحاسبة المالية والتقارير"))
