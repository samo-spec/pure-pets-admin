...
struct AdminListingsView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                AdminLegacyViewControllerWrapper { PPListingsAdminViewController() }
            }
        }
    ...
    private var dossierHeaderView: some View {
        VStack(alignment: .leading, spacing: AdminSpacing.xs) {
            ...
            Text(Language.get("CommandCenter_Tab_More", alter: "المزيد") + " / " + Language.get("Listings_Title", alter: "القوائم"))
                .font(AdminType.caption1)
                .foregroundColor(AdminSurface.secondaryText)
                .padding(.top, 2)

            Text(Language.get("Listings_Title", alter: "إدارة الإعلانات والقوائم"))
