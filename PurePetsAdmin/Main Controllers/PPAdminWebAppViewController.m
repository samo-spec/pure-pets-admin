...
- (void)viewDidLoad {
    ...
    indicator.color = AppPrimaryClr ?: UIColor.systemBlueColor;
    ...
    errorContainer.backgroundColor = AppForgroundColr ?: UIColor.secondarySystemBackgroundColor;
    ...
    errorTitle.textColor = UIColor.labelColor;
    ...
    errorMessage.textColor = UIColor.secondaryLabelColor;
