//
//  SetUserPermissionsRolesViewController.m
//  PurePetsAdmin
//
...
@interface SetUserPermissionsRolesViewController () <PPImageCollectionDelegate>
...
@implementation SetUserPermissionsRolesViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = kLang(@"User_Management");
