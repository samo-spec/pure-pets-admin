...
#pragma mark - Permission Keys Constants (159 Permissions)
...
extern NSString * const kStaffPermReturnsLivePetView;
extern NSString * const kStaffPermReturnsLivePetCreate;
...
extern NSString * const kStaffPermCommunityMatchSensitiveEvidence;
