...
const CGFloat CHUNK_WIDTH = 120.0f;
...
- (void)startAnimating
{
    ...
    for (UIView *v in self.progressChunks) {
        ...
        [self animateProgressChunk:v delay:(delay += 0.20)];
    }
}
...
{
    [UIView animateWithDuration:0.85 delay:delay options:UIViewAnimationOptionCurveEaseInOut animations:^{
