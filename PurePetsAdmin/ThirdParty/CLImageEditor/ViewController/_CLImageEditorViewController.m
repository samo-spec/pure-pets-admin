...
static const CGFloat kNavBarHeight = 54.0f;
...
- (void)initNavigationBar
{
    ...
    if(_navigationBar==nil){
        ...
        navigationItem.leftBarButtonItem  = [[UIBarButtonItem alloc] initWithImage:[UIImage systemImageNamed:@"multiply.circle"] style:UIBarButtonItemStylePlain target:self action:@selector(pushedCloseBtn:) ];
        navigationItem.rightBarButtonItem = [self createDoneButton];
        navigationItem.leftBarButtonItem.tintColor  = SeconderyTextClr;
        navigationItem.rightBarButtonItem.tintColor  = AppPrimaryClr;
        ...
        navigationBar.titleTextAttributes = @{
                NSFontAttributeName : [Styling fontBold:20], // custom font
                NSForegroundColorAttributeName : AppPrimaryClrDarker
            };
