...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView *iconViewBg = [[UIView alloc] initWithFrame:CGRectMake(10, 5, W-20, W-20)];
        iconViewBg.backgroundColor = AppBackgroundClr;
        iconViewBg.layer.cornerRadius = ( W-20) / 2;
        iconViewBg.clipsToBounds = YES;
        ...
        //_iconView.tintColor = AppForgroundColr;
        _iconView.backgroundColor = UIColor.clearColor;
        _iconView.center = iconViewBg.center;
        [self addSubview:_iconView];
        
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, _iconView.bottom + 10, W, 15)];
...
- (void)setIconImage:(UIImage *)iconImage
{
    ...
    //_iconView.image =  [iconImage imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
}
